...
**FDNFA** is an end-to-end, fully differentiable neural system for **phoneme-level forced alignment** — given a speech waveform and a known phoneme sequence, it predicts precise phoneme boundary timestamps.
